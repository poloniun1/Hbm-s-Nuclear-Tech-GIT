...
public class ItemWatzPellet extends ItemEnumMulti {
	...
	public static enum EnumWatzType {
		...
		SCHRABIDIUM(	0x32FFFF, 0x005C5C, 2_000,	30D,	0.01D,		new FunctionLinear(1.5D), new FunctionSqrtFalling(10D), null),
		...
		LEAD(			0xA6A6B2, 0x03030F, 0,		0,		0.0025D,	null, null, new FunctionLinear(5)), //standard absorber, negative coefficient
		BORON(			0xBDC8D2, 0x29343E, 0,		0,		0.0025D,	null, null, new FunctionLinear(10)), //improved absorber, linear
		DU(			0xC1C7BD, 0x2B3227, 0,		0,		0.0025D,	null, null, new FunctionLinear(15)), //absorber with positive coefficient
		UEU(			0xA1D7BD, 0x1B3227, 0,		10D,	0.0005D,	new FunctionSqrt(60), new FunctionSqrtFalling(10D), null),
		HEU(			0xB6C3C0, 0x110B37, 0,		15D,	0.0005D,	new FunctionSqrt(120), new FunctionSqrtFalling(10D), null),
		HEP(			0xAAD3A0, 0x111A17, 0,		15D,	0.0005D,	new FunctionSqrt(180), new FunctionSqrtFalling(10D), null),
