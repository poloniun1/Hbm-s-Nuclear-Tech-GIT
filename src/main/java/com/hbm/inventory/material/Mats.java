...
public class Mats {
	...
	public static final NTMMaterial MAT_CARBON			= makeSmeltable(	699,		CARBON,				0x363636, 0x030303, 0x404040).setAutogen(WIRE, BLOCK).n();
	...
	public static final NTMMaterial MAT_AU198		= makeSmeltable(7998,		AU198,		0xFFFF8B, 0xC26E00, 0xE8D754).setAutogen(NUGGET, BILLET, DUST, BLOCK).m();
	public static final NTMMaterial MAT_PB209		= makeSmeltable(8209,		PB209,		0xB38A94, 0x12020E, 0x7B535D).setAutogen(NUGGET, BILLET, DUST, BLOCK).m();
	...
	public static final NTMMaterial MAT_AUSTRALIUM		= makeSmeltable(7997,		AUSTRALIUM,		0xFFEE8B, 0xC26E00, 0xF8D754).setAutogen(NUGGET, BILLET, DUST, BLOCK).m();
	...
	public static final NTMMaterial MAT_ARSENIC			= makeSmeltable(3300,		AS,				0x6CBABA, 0x242525, 0x558080).setAutogen(NUGGET, BLOCK).m();
	...
	public static final NTMMaterial MAT_CALCIUM			= makeSmeltable(2000,		CA,				0xCFCFA6, 0x747F6E, 0xB7B784).setAutogen(DUST, BLOCK).m();
	...
	public static final NTMMaterial MAT_CADMIUM			= makeSmeltable(4800,		CD,				0xFFFADE, 0x350000, 0xA85600).setAutogen(DUST, BLOCK).m();
	public static final NTMMaterial MAT_SILICON			= makeSmeltable(1400,		SI,				0xD1D7DF, 0x1A1A3D, 0x878B9E).setAutogen(FRAGMENT, NUGGET, BILLET, BLOCK).m();
	...
	public static final NTMMaterial MAT_OSMIRIDIUM		= makeSmeltable(7699,		OSMIRIDIUM, 	0xDBE3EF, 0x7891BE, 0xACBDD9).setAutogen(NUGGET, CASTPLATE, WELDEDPLATE, BLOCK).m();
	...
	public static final NTMMaterial MAT_EUPH		= makeSmeltable(9000,		EUPH,				0xC76EC9, 0x3F2D42, 0xE576B1).setAutogen(NUGGET, DUST, BLOCK).m();
	public static final NTMMaterial MAT_WHITE_P		= makeSmeltable(1501,	P_WHITE,			0xFFFFFF, 0xC0A192, 0xF1DBD4).setAutogen(BLOCK).n();
