...
public class TileEntityPWRController extends TileEntityMachineBase implements IGUIProvider, IControlReceiver, SimpleComponent, IFluidStandardTransceiver,IEnergyGenerator {
	...
	private void Generate() {
		for(BlockPos pos : ports) {
			...
			this.sendPower( worldObj, portPos.getX(), portPos.getY(), portPos.getZ(), dir);
			}
			}
