...
public class TileEntityReactorResearch extends TileEntityMachineBase implements IControlReceiver, SimpleComponent, IGUIProvider, IInfoProviderEC,IEnergyGenerator  {
	...
	private void Generate() {
			...
			for(int i =0; i<3; i++)			
			this.sendPower( worldObj, xCoord + dir.offsetX, yCoord + i + dir.offsetY, zCoord + dir.offsetZ,  dir);
			}
