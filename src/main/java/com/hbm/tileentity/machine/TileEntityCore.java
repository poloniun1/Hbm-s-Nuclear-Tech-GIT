...
public class TileEntityCore extends TileEntityMachineBase implements IGUIProvider, IInfoProviderEC {
	...
	public void updateEntity() {
		...
		if(!worldObj.isRemote) {
			if(!RBMKDials.getDFCBABY(worldObj)&&tanks[0].getTankType()==Fluids.ASCHRAB&&tanks[1].getTankType()==Fluids.BALEFIRE){
			tanks[0].setTankType(Fluids.DEUTERIUM);
			tanks[1].setTankType(Fluids.TRITIUM);
			}
